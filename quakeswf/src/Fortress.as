package 
{
	...
	public class Fortress extends Sprite 
	{
		...
		private var EmbeddedIDPak0:Class;
		[Embed(source="../embed/id1/PAK1.PAK", mimeType="application/octet-stream")]
		private var EmbeddedIDPak1:Class;
		[Embed(source="../embed/fortress/PAK0.PAK", mimeType="application/octet-stream")]
		private var EmbeddedPak0:Class;
		[Embed(source="../embed/fortress/PAK1.PAK", mimeType="application/octet-stream")]
		private var EmbeddedPak1:Class;
		[Embed(source="../embed/fortress/PAK2.PAK", mimeType="application/octet-stream")]
		private var EmbeddedPak2:Class;
		[Embed(source="../embed/fortress/PAK3.PAK", mimeType="application/octet-stream")]
		private var EmbeddedPak3:Class;
		[Embed(source="../embed/fortress/config.cfg", mimeType="application/octet-stream")]
		private var EmbeddedDefaultConfig:Class;
		[Embed(source="../embed/fortress/autoexec.cfg", mimeType="application/octet-stream")]
		private var EmbeddedDefaultAutoexec:Class;
		
		public function Fortress():void 
		{
			if (stage) init();
		...
		private function init(e:Event = null):void 
		{
			...
			var pakFile2:ByteArray = new EmbeddedPak2;
			_loader.supplyFile("./id1/pak2.pak", pakFile1);
			var pakFile3:ByteArray = new EmbeddedPak3;
			_loader.supplyFile("./id1/pak3.pak", pakFile1);
			var idpakFile0:ByteArray = new EmbeddedIDPak0;
			_loader.supplyFile("./id1/pak4.pak", idpakFile0);
			var idpakFile1:ByteArray = new EmbeddedIDPak1;
			_loader.supplyFile("./id1/pak5.pak", idpakFile1);
